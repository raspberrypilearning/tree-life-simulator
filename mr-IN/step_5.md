...
**Tree Feller** स्प्राईटवर क्लिक करा आणि `when this sprite clicked`{:class="block3events"} ब्लॉकसह नवीन स्क्रिप्ट चालू करा. `ask What is your name? and wait`{:class="block3sensing"} ब्लॉकची प्रतिक्षा करा आणि टेक्स्ट बदला `How many trees are needed? (max 20)` हे विचारण्यासाठी:
...
पुढे, पुढील प्रश्न विचारण्यातून इनपुट ठेवण्यासाठी व्हेरिएबलची तुम्हाला आवश्यकता आहे `How many trees are needed? (max 20)`.
...
`Looks`{:class="block3looks"} ब्लॉक तुमच्या कोडच्या शेवटी जोडा जेणेकरून **Tree Feller** स्प्राईट `say`{:class="block3looks"} `Requests completed.` `for 2 seconds`{:class="block3looks"}:
